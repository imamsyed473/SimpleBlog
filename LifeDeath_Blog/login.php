                    ...
                    <form role="form">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-12">
                                ...
                                <input type="password" id="password" name="password" maxlength="250" class="form-control" style="width: 400px">
                            </div>
							<br>
                            <div class="form-group col-lg-12">                     
					 ...
					 <div class="form-group col-lg-12">                     
                      <a href="register.php">
                     <button type="submit" id="login" class="btn btn-default" style="background-color: #e7e7e7; color: black;"><strong>Not a Member? Register here</strong></button> </a>
                            </div>
