...
<head>
    ...
    <title>Life - Death / Register</title>
                    ...
                    <form role="form">
                        <div class="row">
                            <div class="form-group col-lg-4">
                                ...
                                <input type="text" id="fname" name="fname" maxlength="250" class="form-control">
                            </div>
							 
                            <div class="form-group col-lg-4">
                                <label>Last Name</label>
                        <input type="text"  id="lname" name="lname" maxlength="250" class="form-control">
                            </div>
                            ...
                            &nbsp&nbsp&nbsp&nbsp    <button type="submit" id="register" class="btn btn-default">Submit</button>
                            </div>
                        </div>
                    </form>
                </div>
